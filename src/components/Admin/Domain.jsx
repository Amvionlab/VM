...
const Form = () => {
  ...
  return (
    <div className="bg-second max-h-full w-full relative text-xs mx-auto p-1 lg:overflow-y-hidden h-full ticket-scroll">
      {showForm && (
      ...
      <div className="w-full h-full relative bg-box p-3 rounded-lg font-mont">
