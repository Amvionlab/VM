...
const Form = () => {
  ...
  const exportCSV = () => {
    ...
    // Create CSV content
    const csvContent = [
      tableHeaders.join(","), // Add headers to CSV
  ...
  const columns = [
    ...
    { id: "min", label: "Min Time", minWidth: 170 },
    { id: "max", label: "Max Time", minWidth: 170 },
  ];
  ...
  return (
    <div className="bg-second max-h-5/6 w-full relative  text-xs mx-auto p-1 lg:overflow-y-hidden h-auto ticket-scroll">
                ...
                <div className="mb-4 mr-4 md:mr-0 md:w-4/6 flex justify-center items-center">
                  <div className="w-full md:w-full">
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full text-base h-16 bg-box border border-gray-400 p-2 rounded-md outline-none transition ease-in-out delay-150   "
                    ></textarea>
                  </div>
                  <button
                    type="submit"
      ...
      <div className="w-full h-full relative m-0.5 bg-box p-3 rounded-lg font-mont">
