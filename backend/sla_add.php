...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Insert user data into 'sla' table
    $sql = "INSERT INTO sla (level, description, min_time, max_time, is_active) VALUES ('$level', '$description', '$min', '$max', '$active')"; 

    if ($conn->query($sql) === TRUE) {
        $response = array('success' => true, 'message' => 'SLA added successfully.');
